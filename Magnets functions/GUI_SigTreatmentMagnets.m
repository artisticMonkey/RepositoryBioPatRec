...
%
% Biop was initially developed by Max J. Ortiz C. at Integrum AB and 
...
function varargout = GUI_SigTreatmentMagnets(varargin)
% GUI_SIGTREATMENTMAGNETS M-file for GUI_SigTreatmentMagnets.fig
%      GUI_SIGTREATMENTMAGNETS, by itself, creates a new GUI_SIGTREATMENTMAGNETS or raises the existing
%      singleton*.
%
%      H = GUI_SIGTREATMENTMAGNETS returns the handle to a new GUI_SIGTREATMENTMAGNETS or the handle to
%      the existing singleton*.
%
%      GUI_SIGTREATMENTMAGNETS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_SIGTREATMENTMAGNETS.M with the given input arguments.
%
%      GUI_SIGTREATMENTMAGNETS('Property','Value',...) creates a new GUI_SIGTREATMENTMAGNETS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GUI_SigTreatmentMagnets_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUI_SigTreatmentMagnets_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GUI_SigTreatmentMagnets_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_SigTreatmentMagnets_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GUI_SigTreatmentMagnets is made visible.
function GUI_SigTreatmentMagnets_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GUI_SigTreatmentMagnets (see VARARGIN)
...
% Choose default command line output for GUI_SigTreatmentMagnets
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes GUI_SigTreatmentMagnets wait for user response (see UIRESUME)
% uiwait(handles.GUI_SigTreatmentMagnets);
movegui(hObject,'center');

% --- Outputs from this function are returned to the command line.
function varargout = GUI_SigTreatmentMagnets_OutputFcn(hObject, eventdata, handles) 
...
function et_tw_Callback(hObject, eventdata, handles)
    ...
    Psr = str2double(get(handles.et_nCh,'String'));
...
function pb_treatFolder_Callback(hObject, eventdata, handles)
    ...
    for rn =1 : 100
        if exist([lpath filesep num2str(rn) '.mat'], 'file')
            ...
            % Pre-processing
            sigTreated = PreProcessingMagnets(handles);            
            % Treat the Data
...
% hObject    handle to GUI_SigTreatmentMagnets (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes during object creation, after setting all properties.
function t_recSession_CreateFcn(hObject, eventdata, handles)
% hObject    handle to t_recSession (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called


% --- Executes during object creation, after setting all properties.
function pb_preProcessing_CreateFcn(hObject, eventdata, handles)
% hObject    handle to pb_preProcessing (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

function et_nMag_Callback(hObject, eventdata, handles)
% hObject    handle to et_nMag (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of et_nMag as text
%        str2double(get(hObject,'String')) returns contents of et_nMag as a double


% --- Executes during object creation, after setting all properties.
function et_nMag_CreateFcn(hObject, eventdata, handles)
% hObject    handle to et_nMag (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    recSession = Initialize(hObject,handles); 
    %Disable and enable buttons -------------------------------------------
    set(handles.et_sF,'Enable','off');
    set(handles.et_downsample,'Enable','off');
    set(handles.et_nM,'Enable','off');
    set(handles.et_nR,'Enable','off');
    set(handles.et_cT,'Enable','off');
    set(handles.et_rT,'Enable','off');
    set(handles.et_nMag,'Enable','off');
    set(handles.et_nCh,'Enable','off');
    ...
    set(handles.lb_magInput,'Enable','on');
    disp(recSession);
   

% --- Executes on selection change in lb_magInput.
function lb_magInput_Callback(hObject, eventdata, handles)
% hObject    handle to lb_magInput (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns lb_magInput contents as cell array
%        contents{get(hObject,'Value')} returns selected item from lb_magInput


% --- Executes during object creation, after setting all properties.
function lb_magInput_CreateFcn(hObject, eventdata, handles)
% hObject    handle to lb_magInput (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in pm_mag1Ch1.
function pm_mag1Ch1_Callback(hObject, eventdata, handles)
% hObject    handle to pm_mag1Ch1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns pm_mag1Ch1 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from pm_mag1Ch1


% --- Executes during object creation, after setting all properties.
function pm_mag1Ch1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to pm_mag1Ch1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
