...
for i=1:3
    ...
    channel1 = [restSegment restSegment restSegment   restSegment restSegment   restSegment restSegment  ];
    channel2 = [signalSegment restSegment restSegment   restSegment restSegment   restSegment restSegment  ];
