...
% Last Modified by GUIDE v2.5 17-Sep-2019 17:46:27
...
% --- Executes on button press in cb_enableOnlyTarget.
function cb_enableOnlyTarget_Callback(hObject, eventdata, handles)
% hObject    handle to cb_enableOnlyTarget (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
if(get(hObject,'Value'))
    handles.activeTarget = 1;
else
    handles.activeTarget = 0;
end

guidata(hObject,handles);
% Hint: get(hObject,'Value') returns toggle state of cb_enableOnlyTarget
...
% --- Executes during object creation, after setting all properties.
function rb_3dof_CreateFcn(hObject, eventdata, handles)
% hObject    handle to tb_executeTime (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes during object creation, after setting all properties.
function pb_start_DeleteFcn(hObject, eventdata, handles)
% hObject    handle to tb_executeTime (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in rb_3dof.
function rb_3dof_Callback(hObject, eventdata, handles)
% hObject    handle to rb_3dof (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of rb_3dof



function tb_speedSamples_Callback(hObject, eventdata, handles)
% hObject    handle to tb_speedSamples (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of tb_speedSamples as text
%        str2double(get(hObject,'String')) returns contents of tb_speedSamples as a double


% --- Executes during object creation, after setting all properties.
function tb_speedSamples_CreateFcn(hObject, eventdata, handles)
% hObject    handle to tb_speedSamples (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
