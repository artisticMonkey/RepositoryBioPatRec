...
% Last Modified by GUIDE v2.5 12-Jul-2019 16:10:37
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    drawnow;
    if isfield(handles,'cb_ALCD') && get(handles.cb_ALCD,'Value')
        MotionTestALCD(patRec, handles);
    else
...
TacHandles.pTable = handles.patRec.pTable; 

GUI_plot = eval('GUI_PatRecPlot');
TacPlot = guidata(GUI_plot);
TacPlot.mainGUI = hObject;
guidata(GUI_plot,TacPlot);

GUI_toggles = eval('GUI_nearToggles');
TacToggles = guidata(GUI_toggles);
TacToggles.mainGUI = hObject;
guidata(GUI_toggles,TacToggles);

TacHandles.TACTestPlot = TacPlot;
TacHandles.TacTestToggles = TacToggles;
...
function et_debug_Callback(hObject, eventdata, handles)
% hObject    handle to et_debug (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of et_debug as text
%        str2double(get(hObject,'String')) returns contents of et_debug as a double

% --- Executes during object creation, after setting all properties.
function et_debug_CreateFcn(hObject, eventdata, handles)
% hObject    handle to et_debug (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function et_handClass_Callback(hObject, eventdata, handles)
% hObject    handle to et_handClass (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of et_handClass as text
%        str2double(get(hObject,'String')) returns contents of et_handClass as a double


% --- Executes during object creation, after setting all properties.
function et_handClass_CreateFcn(hObject, eventdata, handles)
% hObject    handle to et_handClass (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function et_wristClass_Callback(hObject, eventdata, handles)
% hObject    handle to et_wristClass (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of et_wristClass as text
%        str2double(get(hObject,'String')) returns contents of et_wristClass as a double


% --- Executes during object creation, after setting all properties.
function et_wristClass_CreateFcn(hObject, eventdata, handles)
% hObject    handle to et_wristClass (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function et_newOut_Callback(hObject, eventdata, handles)
% hObject    handle to et_newOut (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of et_newOut as text
%        str2double(get(hObject,'String')) returns contents of et_newOut as a double


% --- Executes during object creation, after setting all properties.
function et_newOut_CreateFcn(hObject, eventdata, handles)
% hObject    handle to et_newOut (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
