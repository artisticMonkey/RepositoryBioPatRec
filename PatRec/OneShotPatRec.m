...
function [outMov outVector] = OneShotPatRec(patRecTrained,tSet)
    ...
    elseif strcmp(patRecTrained.algorithm,'SVM')
        ...
        %%
    elseif strcmp(patRecTrained.algorithm,'SVMt')||strcmp(patRecTrained.algorithm,'SVMcv')
        
        [outMov outVector] = SVMTest(patRecTrained, tSet);
        
    elseif strcmp(patRecTrained.algorithm,'SVMtHW')
        
        [outMov outVector] = SVMTest_TransHW(patRecTrained, tSet);
       %%
...
%         outMov = find(round(outVector));
    ...
    elseif strcmp(patRecTrained.algorithm,'ANNt')
        
        [outMov outVector] = ANNTest(patRecTrained, tSet);
        
    elseif strcmp(patRecTrained.algorithm,'LDAt')
        
        [outMov outVector] = LDATest(patRecTrained, tSet);
