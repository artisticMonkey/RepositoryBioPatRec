...
function [transientSet, transientOut, threshold, midRangeValue, rangeValue, dNoiseMAV] = GetSets_Stack_TransientMov_Luis_CrossRepetition(sigFeatures, features, transLength, patRec, plotFlag, varargin)
