...
function varargout = one_motro_test_panel_fig(varargin)
% ONE_MOTRO_TEST_PANEL_FIG M-file for one_motro_test_panel_fig.fig
%      ONE_MOTRO_TEST_PANEL_FIG, by itself, creates a new ONE_MOTRO_TEST_PANEL_FIG or raises the existing
%      singleton*.
%
%      H = ONE_MOTRO_TEST_PANEL_FIG returns the handle to a new ONE_MOTRO_TEST_PANEL_FIG or the handle to
%      the existing singleton*.
%
%      ONE_MOTRO_TEST_PANEL_FIG('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ONE_MOTRO_TEST_PANEL_FIG.M with the given input arguments.
%
%      ONE_MOTRO_TEST_PANEL_FIG('Property','Value',...) creates a new ONE_MOTRO_TEST_PANEL_FIG or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before one_motro_test_panel_fig_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to one_motro_test_panel_fig_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help one_motro_test_panel_fig

% Last Modified by GUIDE v2.5 29-Jul-2009 12:34:18

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @one_motro_test_panel_fig_OpeningFcn, ...
                   'gui_OutputFcn',  @one_motro_test_panel_fig_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before one_motro_test_panel_fig is made visible.
function one_motro_test_panel_fig_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to one_motro_test_panel_fig (see VARARGIN)

% Choose default command line output for one_motro_test_panel_fig
...
% UIWAIT makes one_motro_test_panel_fig wait for user response (see UIRESUME)
% uiwait(handles.fig_one_motor_test_panel);


% --- Outputs from this function are returned to the command line.
function varargout = one_motro_test_panel_fig_OutputFcn(hObject, eventdata, handles) 
