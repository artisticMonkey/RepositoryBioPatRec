function varargout = GUI_TestStellarisWiicom(varargin)
% GUI_TESTSTELLARISWIICOM MATLAB code for GUI_TestStellarisWiicom.fig
%      GUI_TESTSTELLARISWIICOM, by itself, creates a new GUI_TESTSTELLARISWIICOM or raises the existing
%      singleton*.
%
%      H = GUI_TESTSTELLARISWIICOM returns the handle to a new GUI_TESTSTELLARISWIICOM or the handle to
%      the existing singleton*.
%
%      GUI_TESTSTELLARISWIICOM('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_TESTSTELLARISWIICOM.M with the given input arguments.
%
%      GUI_TESTSTELLARISWIICOM('Property','Value',...) creates a new GUI_TESTSTELLARISWIICOM or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GUI_TestStellarisWiicom_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUI_TestStellarisWiicom_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GUI_TestStellarisWiicom

% Last Modified by GUIDE v2.5 30-May-2013 15:14:08

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GUI_TestStellarisWiicom_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_TestStellarisWiicom_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GUI_TestStellarisWiicom is made visible.
function GUI_TestStellarisWiicom_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GUI_TestStellarisWiicom (see VARARGIN)

% Choose default command line output for GUI_TestStellarisWiicom
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes GUI_TestStellarisWiicom wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GUI_TestStellarisWiicom_OutputFcn(hObject, eventdata, handles) 
...
%            if fread(obj,1) == 69        
                centValue = value16;% -  32767;       % Center the data
