...
% Last Modified by GUIDE v2.5 14-Oct-2022 16:25:26
...
strMeth = {'SWT','SWT + SigSep','DWT','DWT + SigSep','ALCD'};
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.t_stopAcq,'Value',1);


% --- Executes during object creation, after setting all properties.
function a_effortPlot_CreateFcn(hObject, eventdata, handles)
% hObject    handle to a_effortPlot (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

% Hint: place code in OpeningFcn to populate a_effortPlot
