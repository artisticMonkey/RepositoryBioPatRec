...
function [trData, vData, tData, trSSdata] = ApplyFiltersEpochs(sigTreated, trData, vData, tData, trSSdata)
 ...
 [trData, vData ,tData, trSSdata] = SplitCatData(dataAll,sigTreated);
