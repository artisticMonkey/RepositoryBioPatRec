...
function [trDataDenoised, vDataDenoised, tDataDenoised, trSSdata, stopFlag] = ApplySignalDenoising(sigTreated, trData, vData, tData, trSSdata)
...
allData = cat(4,trData,vData,tData,trSSdata);
...
% Uncat Data
[trDataDenoised,vDataDenoised,tDataDenoised, trSSdata] = SplitCatData(allDataDenoised,sigTreated);
